...
export type RequiredSchemeTokenInput = Pick<TreeseedSemanticColorTokens, 'canvas' | 'canvasSubtle' | 'surface' | 'surfaceMuted' | 'surfaceRaised' | 'text' | 'textMuted' | 'border' | 'borderStrong' | 'accent' | 'accentHover' | 'accentStrong' | 'accentSoft' | 'info' | 'success' | 'warning' | 'danger'>;
