...
export const operationsComponents: ComponentCatalogEntry[] = [
  ...
  display('ai-deployment-workspace', 'AiDeploymentWorkspace', 'Capacity', 'astro', 'Searchable team AI drafts, kept separate from provisioned GPU machines.', 'full-page', {}, [{name:'instances',type:'Instance[]',defaultValue:[],description:'Authoritative team draft inventory.'}], undefined, '@treeseed/ui/components/astro/capacity/AiDeploymentWorkspace.astro'),
  display('operational-list', 'OperationalList', 'Operations', 'astro', 'Search and status filters over an authoritative operational inventory.', 'large', {}, [{name:'rows',type:'Row[]',defaultValue:[],description:'Named resources with status, description and management link.'}], undefined, '@treeseed/ui/components/astro/surface/OperationalList.astro'),
  display('management-wizard', 'ManagementWizard', 'Operations', 'astro', 'Focused management steps with validated transitions and preserved form drafts.', 'large', {}, [{name:'steps',type:'string[]',defaultValue:['Details','Review'],description:'Named panels displayed one at a time.'}], undefined, '@treeseed/ui/components/astro/navigation/ManagementWizard.astro'),
  display('vault-setup-preview', 'VaultSetupPreview', 'Services', 'astro', 'Managed storage explanation and custom vault setup flow.', 'full-page', {}, [{name:'canManage',type:'boolean',defaultValue:true,description:'Shows authorized setup actions.'}], undefined, '@treeseed/ui/components/astro/service/workspace/VaultSetupPreview.astro'),
